...
function wolf_step!(Union{predator,prey}, model)
...
function initialize(; total_agents = 5, size = (10.0, 10.0), min_safe_distance = 0.1, seed = 125)
    ...
    rng = Xoshiro(seed)
    model = StandardABM(Union{Wolf,Sheep}, space; properties, agent_step! = wolf_step!, agent_step! = sheep_step!, rng,
    ...
    add_agent!(Sheep, model; vel = (0.0, 0.0))
